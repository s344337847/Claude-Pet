...
export const ganyuStyle: StyleConfig = {
    name: 'ganyu',
    initialFacing: -1,
    colors: { primary: '#d77757', work: '#d77757', success: '#d77757', fail: '#889999', sleep: '#d77757' },
    spriteSheet: {
        imageSrc: '/src/assets/sprites/Ganyu-xll.png',  // 放入 public/sprites/ 目录
        ...
        states: {
            ...
            sleep: { row: 2, frameCount: 13 },                // 第3行，1帧（默认 frameRate: 6）
            success: { row: 2, frameCount: 13 },                // 第3行，1帧（默认 frameRate: 6）
            fail: { row: 2, frameCount: 13 },                // 第4行，1帧（默认 frameRate: 6）
        },
    },
    body: {
